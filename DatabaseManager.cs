...
namespace Ricu_Racu
{
    public class DatabaseManager
    {
        ...
        new[] { "Vašingtona", "Rīga", "Tallina" },
        new[] { "Austrālijā", "Havaju salās", "Karību jūrā" },
        new[] { "Juras laikmeta parks", "Dinozauru sala", "Aizvēsturiskais parks" },
        new[] { "Jā", "Nē", "Tikai māsa" },
        new[] { "Mufasa", "Skars", "Dambo" },
        new[] { "Jā", "Nē", "Tikai mazuļiem" },
        new[] { "Strauss", "Ērglis", "Pingvīns" },
        new[] { "Simtjūdžu mežā", "Rīgas ZOO", "Okeānā" },
        new[] { "Mellenes", "Zemenes", "Ķirbji" },
        new[] { "Vudijs", "Bembijs", "Sūklis Bobs" },
        new[] { "Zilais valis", "Zilonis", "Suns" },
        new[] { "Žirafe", "Garnele", "Anakonda" },
        new[] { "Temperatūru", "Spiedienu", "Ātrumu" },
        new[] { "Metāla", "Plastmasas", "Koka" },
        new[] { "Medu", "Pienu", "Vasku" },
        new[] { "Dzeltenums", "Baltums", "Brūnums" },
        new[] { "Zaļā", "Sarkanā", "Dzeltenā" },
        new[] { "Ziemeļpolā", "Dienvidpolā", "Austrumpolā" },
        new[] { "Melni", "Sarkani", "Brūni" },
        new[] { "8", "6", "10" },
        new[] { "100", "50", "1000" },
        new[] { "9", "7", "3" },
        new[] { "Kuldīgā", "Rīgā", "Kārsavā" },
        new[] { "2", "1", "0" },
        new[] { "5", "10", "23" },
        new[] { "7", "8", "22" },
        new[] { "10", "12", "14" },
        new[] { "Kanbera", "Melburna", "Sidneja" },
        new[] { "Pi", "Pica", "Eur" },
        new[] { "12", "10", "14" },
        new[] { "35", "25", "45" },
        new[] { "Taisns leņķis", "Šaurs leņķis", "Platais leņķis" },
        new[] { "Izstieptais leņķis", "Lielais leņķis", "Pilns leņķis" },
        new[] { "5", "10", "50" },
        new[] { "10", "100", "1000" },
        new[] { "100", "50", "500" },
        new[] { "24", "12", "36" },
