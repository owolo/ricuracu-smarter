...
namespace Ricu_Racu
{
    public partial class Form2 : Form
    {
        ...
        {
            if (atbildeBut1.Text == atbildes[seciba[piemeri]])
            {
                dice.Visible = false;
                dice.BackColor = Color.Red;
        ...
        {
            if (atbildeBut2.Text == atbildes[seciba[piemeri]])
            {
                dice.Visible = false;
                dice.BackColor = Color.Red;
        ...
        {
            if (atbildeBut3.Text == atbildes[seciba[piemeri]])
            {
                dice.Visible = false;
                dice.BackColor = Color.Red;
